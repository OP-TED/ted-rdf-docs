...
The structure of a eForms mapping suite is similar to the structure of the Standard Forms (SF) mapping suite, which is documented https://docs.ted.europa.eu/ODS/mapping_suite/mapping-suite-structure.html[here].
...
The content of the "Metadata" sheet of an eForms Conceptual Mapping (which is slightly different from the https://docs.ted.europa.eu/ODS/mapping_suite/methodology.html#_the_metadata_sheet[Metadata sheet] of a Standard Forms CM) looks like this:
