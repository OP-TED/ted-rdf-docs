...
. Choose "Table x" and click on either "Load", or "Transform Data". "Load" will copy all columns as is into an Excel sheet. "Transform Data" will open a Power Query window that will give you the opportunity to choose the columns you wish and to do some manipulation of the data before it is transferred to the Excel sheet. "Close and Load".
