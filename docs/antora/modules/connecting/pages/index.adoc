...
=== Querying directly via the TED SPARQL EndPoint

If you are new to querying RDF data, you can start by pasting a sample query directly into the TED SPARQL Endpoint. You can view the results online and/ or download them in a variety of formats.

xref:connecting:sparql.adoc[How to query directly via the TED SPARQL EndPoint]
