...
As an aid, you can use these short info session on xref:../../../query_central/attachment$Notice_Data/index.html[Notice Data] and xref:../../../query_central/attachment$Searching_Notices/index.html[Searching Notices] to familiarise yourself with notices and how to use the ted.europa.eu search possibilities.
