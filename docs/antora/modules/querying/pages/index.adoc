...
This section on querying public procurement data introduces the resources and guides available to help those interested improve their querying knowledge and skills.
...
Online resources for learning RRDF, SPARQL
