...
****
To convert notice XML documents to RDF we create appropriate mappings using RML (the RDF Mapping Language). These mappings are made available for re-use. Find out how to re-use these mappings in your own projects.
