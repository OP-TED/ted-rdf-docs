...
a|* From 1st March 2023 until current day - 1 

a|* From 28th August 2023 until 26th January 2024

a|* conforms to the eProcurement Ontology V4 +
(to be upgraded to ePO v5)

a|* conforms to the eProcurement Ontology v3.1 +
(to be upgraded to ePO v5)

a|* Daily eForms notices of all SDK versions until 1.14 (included)

a|* A limited number of XML notices are available in Cellar. These were produced during the initial TED Open Data Service Pipeline proof of concept.

* Form types F3, F6, F21, F22, F23, F25

a|* Support for SDK version 1.15 coming in 2026

a|* Support for the remaining form types coming in 2026
|===
