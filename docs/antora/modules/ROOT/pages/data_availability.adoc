...
== Legislation directly affects data
...
NOTE: As these change slightly with amendments in legislation, the exact fields might not be carried through from the beginning of data collection to now, or their class names might have changed, or fields might have been added and removed along the way.
