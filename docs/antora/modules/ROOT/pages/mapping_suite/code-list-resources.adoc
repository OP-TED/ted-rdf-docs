...
*Important note:* Please ensure that the above paths are adapted to the resources to match the tag and mapping suite package that you wish to check. For example, for the `2.1.1-rc.1` tag and for form `F06`, the links mentioned above will be:
