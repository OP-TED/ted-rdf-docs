...
* The minimal set of the most representative notices were selected for each form_number and eforms_subtype .
...
A separate sampling on *all the TED notices published between 2014 and 2022* was also made. The samples were split up according to the various XSD versions upon which they were created. These samples can be found in the following folder structure:
