...
This chapter shows an example of a spreadsheet in MS Excel with macros that is querying TED-SWS data. The spreadsheet can be found in the https://github.com/OP-TED/ted-rdf-docs/blob/main/spreadsheets/sample_application.xlsm[GitHub Repository].
