...
. When opening the downloaded spreadsheet and depending on the version of MS Excel used, a pop-up box might appear asking you to choose a privacy level. Set it to Ignore Privacy Levels checks by ticking the checkbox, and then click "Save".
...
[arabic, start=4]
. In the "Sample analysis" sheet is an example of analysis of the query result. Press "Update tables" button to update the Pivot tables and plots.
