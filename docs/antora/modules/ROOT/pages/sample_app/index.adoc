...
The next most advanced method is submitting a query directly into the SPARQL EndPoint. Here you can choose the desired returned data format from the options, and deal with the formating of the results ias you wish.

The last two options are for users with some knowledge of R and Python, and require the user to programme the connection to the SPARQL EndPoint using the API
