...
The next method is submitting a query directly into the SPARQL EndPoint. Here you can choose the desired returned data format from the options, and deal with the formating of the results as you wish.

The last two query options are using Jupiter Notebook with either R and Python.
