...
In most cases you will start a new query process with a specific scenario or context in which a question about EU public procurement is asked. The following steps then follow:
...
Sample appications are provided for you to try out using the following query methods:
...
The next most advanced method is submitting a query directly into the SPARQL EndPoint. Here you can choose the desired returned data format from the options, and deal with the formating of the results as you wish.

The last two options are for users with some knowledge of R and Python.
