...
Before preceding, ensure that Python and Jupyter Notebook are already installed. This can be done using tutorial in <<SWS:ROOT:sample_app/jupyter_notebook_python.adoc#, this>> section.
