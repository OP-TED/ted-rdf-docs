...
= Retrieving Competition Notices: Procedure Types and Buyers
...
[source, sparql]
----
include::../queries/competition-notices.sparql[]
----
...
The query extracts the legal name and country about organizations that play the epo:Buyer role.
